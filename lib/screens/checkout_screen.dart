...
class _CheckoutBottomSheetState extends State<CheckoutBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Consumer<Booking>(builder: (context, booking, child) {
        if (pageSelector == 0)
        // SelectDate
        {
          return Column(
                ...
                child: GestureDetector(
                    onTap: () {
                      ...
                      booking.updateEndDate(
                          _pickerController.selectedRange.endDate);
                      setState(() {
                        pageSelector = 1;
                      });
                    },
                ...
                child: GestureDetector(
                    onTap: () {
                      ...
                      if (name1.text.isNotEmpty) {
                        ...
                        booking.updatePrice((widget.trekData['price']) *
                ...
                child: GestureDetector(
                    onTap: () async {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content:
                            Text('Your trek has been successfully booked.'),
                      ));
                      setState(() {
                        _checkout = false;
                      });
